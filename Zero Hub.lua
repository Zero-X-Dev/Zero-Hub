...
local HoldAndSkillTab = Window:AddTab("Hold And Skill")
local SeaSettingsTab = Window:AddTab("Sea Settings")
local ShopTab = Window:AddTab("Shop")
local MainTab = Window:AddTab("Main Farm")
local MultiFarmTab = Window:AddTab("Multi Farm")
local OthersTab = Window:AddTab("Others")
local FarmingHopTab = Window:AddTab("Farming and Hop")
local FruitTab = Window:AddTab("Fruit")
local RaidTab = Window:AddTab("Raid")
local DungeonTab = Window:AddTab("Dungeon")
local CombatTab = Window:AddTab("PvP")
local RaceTab = Window:AddTab("Race")
local DragonDojoTab = Window:AddTab("Dragon Dojo")
local PrehistoricTab = Window:AddTab("Prehistoric")
local SeaEventTab = Window:AddTab("Sea Event")
local SeaStackTab = Window:AddTab("Islands")
