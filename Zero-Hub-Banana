...
-- Removed gay() function name, kept functionality
(function()
...
local Fz = {
		...
		["Search Icon Highlight Color"] = Color3.fromRGB(200, 200, 200),
		["GUI Text Color"] = Color3.fromRGB(255, 255, 255),
		["Text Color"] = Color3.fromRGB(255, 255, 255),
		["Placeholder Text Color"] = Color3.fromRGB(180, 180, 180),
		...
		["Background 3 Color"] = Color3.fromRGB(15, 15, 15),
		["Background Image"] = "",
		...
		["Slider Line Color"] = Color3.fromRGB(80, 80, 80),
...
gz.Image = "rbxassetid://140318122086207";
...
iz.Thickness = .6;
iz.Color = Color3.fromRGB(255, 255, 255);
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">Zero Hub</font> " .. dz.TitleNameNoti));
...
function Kz.CreateMain(Y)
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">Zero Hub </font> : Blox Fruits";
	...
	F.Position = UDim2.new(0, 5, 0, dz.T1 and 5 or 0);
	F.Size = UDim2.new(0, dz.T1 and 30 or 25, 0, dz.T1 and 15 or 25);
	F.Image = "rbxassetid://140318122086207";
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">Zero Hub </font> : Blox Fruits";
	K.Name = "Background1";
	K.Parent = g;
...
-- New Credits Page
local CreditsPage = Cz.T({ Page_Name = "Credits", Page_Title = "Credits" });
local CreditsSection = CreditsPage.CreateSection("Thanks & Credits");
CreditsSection.CreateLabel({ Title = "Helper: manashvi_ahyeon as noahvx_" });
CreditsSection.CreateLabel({ Title = "Developer: realryzu" });
CreditsSection.CreateLabel({ Title = "Thanks to everyone who supports Zero Hub!" });
CreditsSection.CreateLabel({ Title = "nexora.xyz — always evolving." });
...
local HF = cF.CreateLabel({ Title = " Number Cursed dual katana quests ", Content = "" });
spawn(function()
	while wait(.2) do
		...
		elseif GetWP("Cursed Dual Katana") then
			...
			HF:SetDesc(" Quest Numbers : No Quest!!");
		end;
	end;
end);
cF.CreateToggle({
