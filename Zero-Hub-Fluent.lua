task.spawn(function()
    ...
    if not success then
        warn("Failed to execute auto-load:", err)
    end
end)
...
local Tabs = {
    ...
    Melee = Window:AddTab({Title = "Melee", Icon = "rbxassetid://11162889532"}),
    Quests = Window:AddTab({Title = "Quests", Icon = "rbxassetid://13075622619"}),
    SeaEvent = Window:AddTab({Title = "Sea Events", Icon = "rbxassetid://10709783577"}),
    Mirage = Window:AddTab({Title = "Mirage/V4", Icon = "rbxassetid://11162889532"}),
    Drago = Window:AddTab({Title = "Drago Dojo", Icon = "layers"}),
    Prehistoric = Window:AddTab({Title = "Volcano", Icon = "flame"}),
    Raids = Window:AddTab({Title = "Raids", Icon = "skull"}),
    Travel = Window:AddTab({Title = "Teleports", Icon = "map-pin"}),
    Fruit = Window:AddTab({Title = "Fruits", Icon = "cherry"}),
    Misc = Window:AddTab({Title = "Misc", Icon = "rbxassetid://6031280882"})
}

-- ==================== CREDITS ====================
Tabs.Settings:AddSection("Credits")
Tabs.Settings:AddParagraph({Title = "Zero Hub", Content = "Owner: nexora.xyz"})
Tabs.Settings:AddParagraph({Title = "Helper", Content = "manashvi_ahyeon"})
Tabs.Settings:AddParagraph({Title = "Developer", Content = "realryzu"})
Tabs.Settings:AddParagraph({Title = "Thanks", Content = "Special thanks to everyone who helped make this script possible!"})

-- ==================== ENGLISH UI ELEMENTS ====================
-- (The rest of the UI toggles, dropdowns, etc. are translated to English below)

local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "Farms levels automatically based on your current level", Default = false})
...
local TravelDress = Tabs.Main:AddToggle("TravelDress", {Title = "Auto Travel Dressrosa", Description = "Automatically complete the Dressrosa travel quest", Default = false})
...
local Zou = Tabs.Main:AddToggle("Zou", {Title = "Auto Zou Quest", Description = "Complete the Zou questline automatically", Default = false})
...
Tabs.Main:AddSection("Miscellaneous / Quests")

local ClosetMons = Tabs.Main:AddToggle("ClosetMons", {Title = "Auto Farm Nearest", Description = "Farms the nearest enemy automatically", Default = false})
...
local FactoryRaids = Tabs.Main:AddToggle("FactoryRaids", {Title = "Auto Factory Raid", Description = "Completes Factory raids automatically", Default = false})
...
local CastleRaids = Tabs.Main:AddToggle("CastleRaids", {Title = "Auto Pirate Raid", Description = "Farms pirate raid enemies", Default = false})
...
Toggle = Tabs.Main:AddToggle("Toggle", {Title = "Auto Materials", Description = "Farms selected material automatically", Default = false})
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Farm Ectoplasm", Description = "Farms ectoplasm material", Default = false})
...
local Bartilo = Tabs.Main:AddToggle("Bartilo", {Title = "Auto Done Bartilo Quest", Description = "Completes Bartilo questline", Default = false})
...
local CitizenQ = Tabs.Main:AddToggle("CitizenQ", {Title = "Auto Done Citizen Quest", Description = "Completes Citizen questline", Default = false})
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Training Dummy", Description = "Farms training dummy for mastery", Default = false})
Q:OnChanged(function(Value)
  _G.DummyMan = Value
end)
spawn(function()
...
local Berry = Tabs.Main:AddToggle("Berry", {Title = "Auto Collect Berry", Description = "Collects berry bushes automatically", Default = false})
...
local Chest = Tabs.Main:AddToggle("Chest", {Title = "Auto Collect Chest", Description = "Teleports to and collects chests", Default = false})
...
Tabs.Main:AddSection("Miscellaneous / Mastery")
...
local MasteryFruits = Tabs.Main:AddToggle("MasteryFruits", {Title = "Auto Mastery Fruits", Description = "Farms fruit mastery", Default = false})
...
local MasteryGun = Tabs.Main:AddToggle("MasteryGun", {Title = "Auto Mastery Gun", Description = "Farms gun mastery", Default = false})
...
local MasterySword = Tabs.Main:AddToggle("MasterySword", {Title = "Auto Mastery All Sword", Description = "Farms sword mastery for all swords", Default = false})
...
Tabs.Main:AddSection("General Quests / Items")
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Cake Prince", Description = "Farms Cake Prince and related mobs", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Bones", Description = "Farms bones from haunted island", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Accept Quests", Description = "Auto accepts quests for farming", Default = false})
Q:OnChanged(function(Value)
  _G.AcceptQuestC = Value
end)          
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Farm Mirror", Description = "Farms Dough King", Default = false})
Q:OnChanged(function(Value)
  _G.AutoMiror = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Soul Reaper [Full]", Description = "Completes Soul Reaper quest fully", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Random Bones", Description = "Randomly buys bones", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Try Luck Gravestone", Description = "Uses gravestone for luck", Default = false})
Q:OnChanged(function(Value)
  _G.TryLucky = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Pray Gravestone", Description = "Prays at gravestone", Default = false})
Q:OnChanged(function(Value)
  _G.Praying = Value
end)
spawn(function()
...
Tabs.Main:AddSection("Unlock Dungeons")
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Unlock Dough Dungeon", Description = "Unlocks Dough raid", Default = false})
Q:OnChanged(function(Value)
  _G.Doughv2 = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Unlock Phoenix Dungeon", Description = "Unlocks Phoenix raid", Default = false})
Q:OnChanged(function(Value)
...
Tabs.Main:AddSection("Haki / Aura Colors")
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Teleport Barista Cousin", Description = "Teleports to Barista Cousin", Default = false})
Q:OnChanged(function(Value)
  _G.Tp_MasterA = Value
end)
spawn(function()
...
Tabs.Main:AddButton({Title = "Buy Haki Colors", Description = "Purchases haki colors",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("ColorsDealer","2")
end})
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Rainbow Colors", Description = "Completes Rainbow Haki quest", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Accept Rainbow Quest Faster", Description = "Accepts rainbow quest quickly", Default = false})
Q:OnChanged(function(Value)
  _G.GetQFast = Value
end)

Tabs.Main:AddSection("Observation Haki")
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Farm Observation", Description = "Farms observation haki dodges", Default = false})
Q:OnChanged(function(Value)
  _G.obsFarm = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Observation V2", Description = "Completes observation v2 quest", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Mink V3", Description = "Upgrades Mink race to V3", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Mink = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Human V3", Description = "Upgrades Human race to V3", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Human = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Skypiea V3", Description = "Upgrades Skypiea race to V3", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Fishman V3", Description = "Upgrades Fishman race to V3", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Fish = Value
end)
spawn(function()
...
Tabs.Main:AddSection("Dark Dagger + Valkyrie")
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Valkyrie", Description = "Farms rip_indra for Valkyrie", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Unlock Puzzle", Description = "Unlocks haki puzzle", Default = false})
Q:OnChanged(function(Value)
  _G.AutoUnHaki = Value
end)
...
Tabs.Settings:AddSection("Settings / Configuration")
...
local Bringmob = Tabs.Settings:AddToggle("Bringmob", {Title = "Bring Mobs", Description = "Brings mobs to you", Default = true})
Bringmob:OnChanged(function(Value)
  _B = Value
end)
local BusuAura = Tabs.Settings:AddToggle("BusuAura", {Title = "Auto Turn on Buso", Description = "Automatically activates Busoshoku Haki", Default = true})
...
local RaceV3Aura = Tabs.Settings:AddToggle("RaceV3Aura", {Title = "Auto Turn on Race V3", Description = "Activates race V3 ability automatically", Default = false})
...
local RaceV4Aura = Tabs.Settings:AddToggle("RaceV4Aura", {Title = "Auto Turn on Race V4", Description = "Activates race V4 ability automatically", Default = false})
...
local RandomAround = Tabs.Settings:AddToggle("RandomAround", {Title = "Auto Turn on Spin Position", Description = "Randomly spins around target", Default = false})
RandomAround:OnChanged(function(Value)
  RandomCFrame = Value
end)
local Byp = Tabs.Settings:AddToggle("Byp", {Title = "Turn on Bypass Teleport", Description = "Bypasses teleport detection", Default = false})
Byp:OnChanged(function(Value)
  _G.Bypass = Value
end)
local SafeModes = Tabs.Settings:AddToggle("SafeModes", {Title = "Panic Mode", Description = "Teleports up if health is low", Default = false})
...
local UnDetectedAFK = Tabs.Settings:AddToggle("UnDetectedAFK", {Title = "Anti AFK", Description = "Prevents being kicked for AFK", Default = true})
...
local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {Title = "Remove Hit VFX", Description = "Removes hit effects for performance", Default = false})
...
local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {Title = "Remove Death & Respawn VFX", Description = "Removes death/respawn effects", Default = false})
DisblesVFX:OnChanged(function(Value)
  RDeath = Value
end)
spawn(function()
...
local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {Title = "Disable Notifications", Description = "Disables damage and notification GUI", Default = false})
DisblesVFX:OnChanged(function(Value)
  RemoveDamage = Value
end)
spawn(function()
...
local StatusSelect = Tabs.Settings:AddSlider("StatusSelect",{Title = "Stats Value",Description = "Amount of points to add per upgrade",Default = 10,Min = 0,Max = 1000,Rounding = 1, 
...
local StatsUpg = Tabs.Settings:AddToggle("StatsUpg", {Title = "Auto Melee", Description = "Automatically adds melee stats", Default = false})
...
local StatsUpg = Tabs.Settings:AddToggle("StatsUpg", {Title = "Auto Sword", Description = "Automatically adds sword stats", Default = false})
StatsUpg:OnChanged(function(Value)
  _G.Auto_Sword = Value
end)
spawn(function()
...
local StatsUpg = Tabs.Settings:AddToggle("StatsUpg", {Title = "Auto Gun", Description = "Automatically adds gun stats", Default = false})
StatsUpg:OnChanged(function(Value)
  _G.Auto_Gun = Value
end)
spawn(function()
...
local StatsUpg = Tabs.Settings:AddToggle("StatsUpg", {Title = "Auto Blox Fruit", Description = "Automatically adds fruit stats", Default = false})
StatsUpg:OnChanged(function(Value)
...
local StatsUpg = Tabs.Settings:AddToggle("StatsUpg", {Title = "Auto Defense", Description = "Automatically adds defense stats", Default = false})
StatsUpg:OnChanged(function(Value)
...
Tabs.Melee:AddSection("Fighting Styles")
local SuperHuman = Tabs.Melee:AddToggle("SuperHuman", {Title = "Auto Superhuman", Description = "Unlocks Superhuman fighting style", Default = false})
...
local DeathStep = Tabs.Melee:AddToggle("DeathStep", {Title = "Auto Death Step", Description = "Unlocks Death Step fighting style", Default = false})
...
local SharkManV2 = Tabs.Melee:AddToggle("SharkManV2", {Title = "Auto Sharkman Karate", Description = "Unlocks Sharkman Karate fighting style", Default = false})
...
local ElectricClaw = Tabs.Melee:AddToggle("ElectricClaw", {Title = "Auto Electric Claw", Description = "Unlocks Electric Claw fighting style", Default = false})
...
local DragonTalon = Tabs.Melee:AddToggle("DragonTalon", {Title = "Auto Dragon Talon", Description = "Unlocks Dragon Talon fighting style", Default = false})
...
local Godhuman = Tabs.Melee:AddToggle("Godhuman", {Title = "Auto Godhuman", Description = "Unlocks Godhuman fighting style", Default = false})
...
local SanguineArt = Tabs.Melee:AddToggle("SanguineArt", {Title = "Auto Sanguine Art", Description = "Unlocks Sanguine Art fighting style", Default = false})
...
local Process = Tabs.Quests:AddParagraph({Title = "Elite Progress",Content = ""})
spawn(function()
  while wait(Sec) do
    pcall(function()    
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Elite Quest", Description = "Farms elite hunter quest", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Stop when got God's Chalice", Description = "Stops elite hunt when chalice obtained", Default = true})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Tushita Sword", Description = "Obtains Tushita sword", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Yama Sword", Description = "Obtains Yama sword", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Yama = Value
end)
spawn(function()
...
local CheckCDK = Tabs.Quests:AddParagraph({Title = "CDK Quest Progress",Content = "Quest Numbers:"})
spawn(function()  
  while wait(.2) do 
    if QuestYama_1 == true then 
	 CheckCDK:SetDesc("Quest: Yama 1") 
    elseif QuestYama_2 == true then
	  CheckCDK:SetDesc("Quest: Yama 2") 
    elseif QuestYama_3 == true then
	  CheckCDK:SetDesc("Quest: Yama 3") 
    elseif QuestTushita_1 == true then
	  CheckCDK:SetDesc("Quest: Tushita 1") 
    elseif QuestTushita_2 == true then
	  CheckCDK:SetDesc("Quest: Tushita 2") 
    elseif QuestTushita_1 == true then
	  CheckCDK:SetDesc("Quest: Tushita 2") 
	elseif GetWP("Cursed Dual Katana") then
	  CheckCDK:SetDesc("CDK Completed!")
    end 
  end
end) 
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Get CDK [Final Quest]", Description = "Completes final CDK boss fight", Default = false})
Q:OnChanged(function(Value)
  _G.CDK = Value
end)
spawn(function()    
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Yama CDK", Description = "Completes Yama side of CDK quest", Default = false})
Q:OnChanged(function(Value)
  _G.CDK_YM = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Tushita CDK", Description = "Completes Tushita side of CDK quest", Default = false})
Q:OnChanged(function(Value)
  _G.CDK_TS = Value
end)
spawn(function()
...
Tabs.Quests:AddButton({Title = "Buy Legendary Swords", Description = "Purchases all three legendary swords",
Callback = function()
...
Tabs.Quests:AddButton({Title = "Buy True Triple Katana", Description = "Purchases True Triple Katana",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("MysteriousMan","2")
end})
local Q = Tabs.Quests:AddToggle("Q", {Title = "Tween to Legendary Sword Dealer", Description = "Teleports to legendary sword dealer", Default = false})
Q:OnChanged(function(Value)
  _G.Tp_LgS = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Pole V1", Description = "Farms Pole v1 from Thunder God", Default = false})
Q:OnChanged(function(Value)
  _G.AutoPole = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Pole V2 [Beta]", Description = "Upgrades Pole to v2 using Rumble", Default = false})
Q:OnChanged(function(Value)
  _G.AutoPoleV2 = Value
end)
spawn(function()
...
Tabs.Quests:AddSection("Law/Order Sword")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Law Sword", Description = "Farms Order boss for Law sword", Default = false})
Q:OnChanged(function(Value)
  _G.AutoLawKak = Value
end)
spawn(function()
...
Tabs.Quests:AddButton({Title = "Buy Microchip Law", Description = "Purchases Law microchip",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("BlackbeardReward","Microchip","2")
end})
Tabs.Quests:AddButton({Title = "Start Law Raid", Description = "Starts Law raid",
Callback = function()
  fireclickdetector(workspace.Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
end})

Tabs.Quests:AddSection("East Blue Misc")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Saw Sword", Description = "Farms The Saw boss", Default = false})
Q:OnChanged(function(Value)
  _G.AutoSaw = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Saber Sword", Description = "Completes Saber questline", Default = false})
Q:OnChanged(function(Value)
  _G.AutoSaber = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Cyborg", Description = "Farms Cyborg boss", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Usoap's Hat", Description = "Farms players for Usoap's Hat", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Bisento V2", Description = "Farms Greybeard for Bisento v2", Default = false})
Q:OnChanged(function(Value)
  _G.Greybeard = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Warden Sword", Description = "Farms Chief Warden for Warden sword", Default = false})
Q:OnChanged(function(Value)
  _G.WardenBoss = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Marine Coat", Description = "Farms Vice Admiral for Marine Coat", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Swan Coat", Description = "Farms Swan for Swan Coat", Default = false})
Q:OnChanged(function(Value)
  _G.SwanCoat = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Rengoku Sword", Description = "Farms Awakened Ice Admiral for Rengoku", Default = false})
Q:OnChanged(function(Value)
  _G.IceBossRen = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Key Rengoku", Description = "Farms key for Rengoku", Default = false})
Q:OnChanged(function(Value)
  _G.KeysRen = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Dragon Trident", Description = "Farms Tide Keeper for Dragon Trident", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Long Sword", Description = "Farms Diamond for Long Sword", Default = false})
Q:OnChanged(function(Value)
  _G.LongsWord = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Black Spikey", Description = "Farms Jeremy for Black Spikey", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Dark Blade V3", Description = "Upgrades Dark Blade to V3", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Midnight Blade", Description = "Buys Midnight Blade with ectoplasm", Default = false})
Q:OnChanged(function(Value)
  _G.AutoEcBoss = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Darkbeard", Description = "Farms Darkbeard for Dark Coat", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Unlock Don Swan", Description = "Unlocks Don Swan access", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Swan Glasses", Description = "Farms Don Swan for Swan Glasses", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Bigmom", Description = "Farms Cake Queen", Default = false})
Q:OnChanged(function(Value)
  _G.AutoBigmom = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Cavendish Sword", Description = "Farms Beautiful Pirate for Cavendish", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Twin Hooks", Description = "Farms Captain Elephant for Twin Hooks", Default = false})
Q:OnChanged(function(Value)
  _G.TwinHook = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Serpent Bow", Description = "Farms Hydra Leader for Serpent Bow", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Lei Accessory", Description = "Farms Kilo Admiral for Lei accessory", Default = false})
Q:OnChanged(function(Value)
  _G.AutoKilo = Value
end)
spawn(function()
...
FullMOOn = Tabs.Mirage:AddParagraph({Title = "Full Moon Status",Content = ""})
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Find Mirage Island", Description = "Sails to and finds Mirage Island", Default = false})
Q:OnChanged(function(Value)
  _G.FindMirage = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Tween To Highest Point", Description = "Teleports above Mirage Island", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Collect Gear", Description = "Collects gears on Mirage Island", Default = false})
Q:OnChanged(function(Value)
  _G.TPGEAR = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Change Transparency to See", Description = "Makes gears visible", Default = false})
Q:OnChanged(function(Value)
  _G.can = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Tween Advanced Fruit Dealer", Description = "Teleports to Advanced Fruit Dealer", Default = false})
Q:OnChanged(function(Value)
  _G.Addealer = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Collect Mirage Chest", Description = "Collects chests on Mirage Island", Default = false})
Q:OnChanged(function(Value)
  _G.FarmChestM = Value
end)
spawn(function()
...
Tabs.Mirage:AddSection("Skull Guitar / Misc")
local CheckSoul = Tabs.Mirage:AddParagraph({Title = "Skull Guitar Quest",Content = ""})
spawn(function()
  while wait(.2) do
    pcall(function()
      if Quest1 == true then CheckSoul:SetDesc("Quest: 1")
	  elseif Quest2 == true then CheckSoul:SetDesc("Quest: 2")
	  elseif Quest3 == true then CheckSoul:SetDesc("Quest: 3")
	  elseif Quest4 == true then CheckSoul:SetDesc("Quest: 4")
	  elseif GetWP("Skull Guitar") then CheckSoul:SetDesc("Collected!")
	  else CheckSoul:SetDesc("No Quest")
      end
    end)
  end
end)
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Skull Guitar", Description = "Completes Skull Guitar puzzle", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Farm Material Skull Guitar", Description = "Farms materials for Skull Guitar", Default = false})
Q:OnChanged(function(Value)
...
Tabs.Mirage:AddButton({Title = "Talk With Stone", Description = "Starts Race V4 quest",
Callback = function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Look At Moon", Description = "Looks at moon for race v4 activation", Default = false})
Q:OnChanged(function(Value)
  LookM = Value
end)
...
Tabs.Mirage:AddSection("Trials / V4")
local CheckTier = Tabs.Mirage:AddParagraph({Title = "V4 Tier",Content = ""})
spawn(function()
  pcall(function()
    while wait(.2) do
      CheckTier:SetDesc("V4 Tier: " .. plr.Data.Race.C.Value)
    end
  end)
end)
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Pull Lever", Description = "Pulls levers in Temple of Time", Default = false})
Q:OnChanged(function(Value)
  _G.Lver = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Train V4", Description = "Farms tier and upgrades V4", Default = false})
Q:OnChanged(function(Value)
  _G.AcientOne = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Teleport to Race Doors", Description = "Teleports to appropriate race door", Default = false})
Q:OnChanged(function(Value)
  _G.TPDoor = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Complete Trial Race", Description = "Completes race trials", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Kill Player After Trial", Description = "Kills players after trials", Default = false})
Q:OnChanged(function(Value)
  _G.Defeating = Value
end)
spawn(function()
...
local DojoQ = Tabs.Drago:AddToggle("DojoQ", {Title = "Auto Dojo Trainer", Description = "Completes dojo belt quests (white to black)", Default = false})
...
local BlazeEM = Tabs.Drago:AddToggle("BlazeEM", {Title = "Auto Dragon Hunter", Description = "Farms Blaze Ember and collects", Default = false})
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Tween To Upgrade Draco Trial", Description = "Teleports to upgrade Draco trial", Default = false})
Toggle:OnChanged(function(Value)
  _G.UPGDrago = Value
end)
spawn(function()
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Drago (V1)", Description = "Quest1 + prehistoric event + collect eggs", Default = false})
Toggle:OnChanged(function(Value)
  _G.DragoV1 = Value
end)
spawn(function()
...
local fireflower = Tabs.Drago:AddToggle("fireflower", {Title = "Auto Drago (V2)", Description = "Kill Forest Pirate & collect fireflowers", Default = false})
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Drago (V3)", Description = "Sea event kill terror shark", Default = false})
Toggle:OnChanged(function(Value)
  _G.DragoV3 = Value
end)
spawn(function()
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Relic Drago Trial [Beta]", Description = "Trial v4 - collect relic yourself", Default = false})
Toggle:OnChanged(function(Value)
  _G.Relic123 = Value
end)
spawn(function()
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Train Drago V4", Description = "Trains Drago race v4 and upgrades tier", Default = false})
Toggle:OnChanged(function(Value)
  _G.TrainDrago = Value
end)
spawn(function()
...
local bdrago = Tabs.Drago:AddToggle("bdrago", {Title = "Swap Drago Race", Description = "Changes race to Drago", Default = false})
...
local UpTalon = Tabs.Drago:AddToggle("UpTalon", {Title = "Upgrade Dragon Talon With Uzoth", Description = "Upgrades Dragon Talon", Default = false})
...
Toggle = Tabs.Prehistoric:AddToggle("Toggle", {Title = "Auto Craft Volcanic Magnet", Description = "Farms materials and crafts volcanic magnet", Default = false})
Toggle:OnChanged(function(Value)
  _G.CraftVM = Value
end)
...
Vocan = Tabs.Prehistoric:AddToggle("Vocan", {Title = "Auto Find Prehistoric Island", Description = "Sails to and activates prehistoric island", Default = false})
...
local Vocan = Tabs.Prehistoric:AddToggle("Vocan", {Title = "Auto Patch Prehistoric Event", Description = "Patches volcano, kills golems, removes lava", Default = false})
Vocan:OnChanged(function(Value)
...
Toggle = Tabs.Prehistoric:AddToggle("Toggle", {Title = "Auto Reset When Complete Volcano", Description = "Resets when volcano complete", Default = false})
Toggle:OnChanged(function(Value)
  _G.ResetPH = Value
end)
spawn(function()
    ...
    pcall(function()
      ...
      if spycheck then SPYING:SetDesc("Spy Leviathan: "..tostring(spycheck))
        if tostring(spycheck) == 5 then
          SPYING:SetDesc("Spy Leviathan: Completed!")
        end
      end
    end)
  end
end)
Tabs.SeaEvent:AddButton({Title = "Buy Fracments with Spy", Description = "Buy spy for finding leviathan",
Callback = function()
  replicated:WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("InfoLeviathan","2")
end})
local FloD = Tabs.SeaEvent:AddParagraph({Title = "Frozen Dimension Status",Content = ""})
spawn(function()
  pcall(function()
    while wait(.2) do
...
local Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Teleport Frozen Dimension", Description = "Teleports to frozen dimension and opens gate", Default = false})
Q:OnChanged(function(Value)
  _G.FrozenTP = Value
end)
spawn(function()
...
local Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Drive To Hydra Island", Description = "Sails to Hydra Island", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.SeaEvent:AddDropdown("Q",{Title = "Choose Boat",Values = ListSeaBoat,Multi = false,Default = 1})
Q:OnChanged(function(Value)
  _G.SelectedBoat = Value
end)
Tabs.SeaEvent:AddButton({Title = "Buy Boat", Description = "Purchases selected boat",
Callback = function()
...
local Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Sail Boat", Description = "Sails boat automatically", Default = false})
Q:OnChanged(function(Value)
  _G.SailBoats = Value
end)
spawn(function()
...
Tabs.SeaEvent:AddSection("Entity Sea Events")
...
Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Attack Pirate Grand Brigade", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.PGB = Value
end)
...
local Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Find Kitsune Island", Description = "Sails to Kitsune Island", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Teleport to Active Shrine", Description = "", Default = false})
Q:OnChanged(function(Value)
  ...
  while wait(.2) do
    pcall(function()      
      if plr.PlayerGui.Main.Timer.Visible == true then
        RaidS:SetDesc("Raiding: Active")
      else
        RaidS:SetDesc("Raiding: Inactive")
      end      
    end)
  end
end)
...
local Q = Tabs.Raids:AddToggle("Q", {Title = "Auto Select Dungeon Chip", Description = "Selects chip based on your fruit", Default = false})
Q:OnChanged(function(Value)
...
Tabs.Raids:AddButton({Title = "Buy Dungeon Chip [Beli]", Description = "",
Callback = function()
  if not GetBP("Special Microchip") then replicated.Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip) end
end})
Tabs.Raids:AddButton({Title = "Buy Dungeon Chip [Devil Fruit]", Description = "Uses lowest value fruit",
Callback = function()
...
local Q = Tabs.Raids:AddToggle("Q", {Title = "Auto Start Raid", Description = "Starts raid automatically", Default = false})
Q:OnChanged(function(Value)
...
Q = Tabs.Raids:AddToggle("Q", {Title = "Auto Complete Raid [Safe]", Description = "Completes raid safely", Default = false})
Q:OnChanged(function(Value)
  _G.Raiding = Value
end)
spawn(function()
...
local Q = Tabs.Raids:AddToggle("Q", {Title = "Kill Aura", Description = "Instantly kills enemies in range", Default = false})
Q:OnChanged(function(Value)
  _G.KillH = Value
end)
spawn(function()
...
local Q = Tabs.Raids:AddToggle("Q", {Title = "Auto Next Island", Description = "Teleports to next island", Default = false})
Q:OnChanged(function(Value)
  NextIs = Value
end)
spawn(function()
...
local Q = Tabs.Raids:AddToggle("Q", {Title = "Auto Awakening", Description = "Awakens fruit after raid", Default = false})
Q:OnChanged(function(Value)
...
__indexPlayer = Tabs.Combat:AddParagraph({Title = "Players Online",Content = ""})
spawn(function()
  while wait(Sec) do
    pcall(function()
      for i,v in pairs(game:GetService("Players"):GetPlayers()) do
        if i == 12 then
          __indexPlayer:SetDesc("Players: " .. i .. " / 12 [Max]")
        elseif i == 1 then
          __indexPlayer:SetDesc("Players: " .. i .. " / 12")
        else
          __indexPlayer:SetDesc("Players: " .. i .. " / 12")
        end
      end
...
local SelectedPly = Tabs.Combat:AddDropdown("SelectedPly",{Title = "Choose Player",Values = PlrList,Multi = false,Default = 1})
SelectedPly:OnChanged(function(Value)
  _G.PlayersList = Value
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Teleport to Selected Player", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.TpPly = Value
  pcall(function()
    if _G.TpPly then
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Spectate Selected Player", Description = "", Default = false})
Q:OnChanged(function(Value)
  SpectatePlys = Value
  repeat task.wait(.1)
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Aimbot Camera Closest Player", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.AimCam = Value
end)
task.spawn(function()
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Infinite Mink V3", Description = "Makes Mink V3 infinite", Default = false})
Q:OnChanged(function(Value)
  InfAblities = Value
end)
spawn(function()
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Infinite Energy", Description = "Makes energy infinite", Default = false})
Q:OnChanged(function(Value)
  infEnergy = Value
  if Value then getInfinity_Ability("Energy", infEnergy) end
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Infinite Soru", Description = "Makes Soru infinite", Default = false})
Q:OnChanged(function(Value)
  _G.InfSoru = Value
  if Value then getInfinity_Ability("Soru", _G.InfSoru) end
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Infinite Observation Range", Description = "Makes observation range infinite", Default = false})
Q:OnChanged(function(Value)
  _G.InfiniteObRange = Value
  if Value then getInfinity_Ability("Observation", _G.InfiniteObRange) end
end)

Tabs.Combat:AddSection("Combat / Aimbot Settings")

Q = Tabs.Combat:AddToggle("Q", {Title = "Ignore Same Teams", Description = "Does not aim at same team", Default = false})
Q:OnChanged(function(Value)
  _G.NoAimTeam = Value
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Accept Allies", Description = "Auto accepts ally requests", Default = false})
Q:OnChanged(function(Value)
  _G.AcceptAlly = Value
end)
spawn(function()
...
Tabs.Combat:AddSection("ESP / Entity / Island")
...
Q = Tabs.Combat:AddToggle("Q", {Title = "ESP Island Locations", Description = "", Default = false})
Q:OnChanged(function(Value)
  IslandESP = Value
...
if World2 then
Q = Tabs.Combat:AddToggle("Q", {Title = "ESP Flowers", Description = "", Default = false})
Q:OnChanged(function(Value)
  FlowerESP = Value
...
Q = Tabs.Combat:AddToggle("Q", {Title = "ESP Legendary Sword Dealer", Description = "", Default = false})
Q:OnChanged(function(Value)
  LegenS = Value
...
Q = Tabs.Combat:AddToggle("Q", {Title = "ESP Aura Color Dealer", Description = "", Default = false})
Q:OnChanged(function(Value)
  ColorEsp = Value
...
Q = Tabs.Combat:AddToggle("Q", {Title = "ESP Sea Event Islands", Description = "", Default = false})
Q:OnChanged(function(Value)
...
Q = Tabs.Combat:AddToggle("Q", {Title = "ESP Advanced Fruit Dealer", Description = "", Default = false})
Q:OnChanged(function(Value)
  advanEsp = Value
...
Tabs.Travel:AddSection("Travel - Islands")
Location = {}
for i,v in pairs(workspace["_WorldOrigin"].Locations:GetChildren()) do  
...
GoIsland = Tabs.Travel:AddToggle("GoIsland", {Title = "Auto Travel", Description = "Teleports to selected island", Default = false})
...
Tabs.Travel:AddSection("Travel - Portals")
if World1 then
  Location_Portal = {
    "Sky",
    "UnderWater"
...
GoNPCs = Tabs.Travel:AddToggle("GoNPCs", {Title = "Auto Tween to NPC", Description = "Teleports to selected NPC", Default = false})
...
Tabs.Fruit:AddSection("Fruit Options")
local fruitsOnSale = {}
...
RandomFF = Tabs.Fruit:AddToggle("RandomFF", {Title = "Auto Random Fruit", Description = "Automatically rolls random fruit", Default = false})
...
DropF = Tabs.Fruit:AddToggle("DropF", {Title = "Auto Drop Fruit", Description = "Automatically drops fruits", Default = false})
...
StoredF = Tabs.Fruit:AddToggle("StoredF", {Title = "Auto Store Fruit", Description = "Automatically stores fruits", Default = false})
...
TwF = Tabs.Fruit:AddToggle("TwF", {Title = "Auto Tween to Fruit", Description = "Teleports to spawned fruits", Default = false})
...
BringF = Tabs.Fruit:AddToggle("BringF", {Title = "Auto Collect Fruit", Description = "Brings fruits to you", Default = false})
...
Tabs.Shop:AddButton({Title = "Buy Dragon Claw", Description = "",Callback = function()
...
Tabs.Shop:AddButton({Title = "Buy Electric Claw", Description = "",Callback = function()
  replicated.Remotes.CommF_:InvokeServer("BuyElectricClaw")
end})
Tabs.Shop:AddButton({Title = "Buy Dragon Talon", Description = "",Callback = function()
...
Tabs.Shop:AddButton({Title = "Buy Sanguine Art", Description = "",Callback = function()
...
Tabs.Shop:AddSection("Sea Event Accessories")
...
Tabs.Shop:AddSection("Weapons World 1")
...
Tabs.Misc:AddButton({Title = "Hop to Lowest Ping Server", Description = "",Callback = function()
local HTTPService = game:GetService("HttpService")
...
DisbleLeaderB = Tabs.Misc:AddToggle("DisbleLeaderB", {Title = "Disable Leaderboard GUI", Description = "", Default = false})
...
UnPortal = Tabs.Misc:AddToggle("UnPortal", {Title = "Unlock All Portals", Description = "Unlocks portals without rip_indra kill", Default = false})
...
HakiStat = Tabs.Misc:AddDropdown("HakiStat",{Title = "Select Haki State",Values = HakiSt,Multi = false,Default = 1})
HakiStat:OnChanged(function(Value)
  _G.SelectStateHaki = Value
end)
Tabs.Misc:AddButton({Title = "Change Buso Stage", Description = "",Callback = function()
...
Tabs.Misc:AddButton({Title = "Boost Boat Speed", Description = "",Callback = function()
...
dayornight = Tabs.Misc:AddToggle("dayornight", {Title = "Turn on Time Changer", Description = "", Default = false})
...
walkWater = Tabs.Misc:AddToggle("walkWater", {Title = "Turn on Walk on Water", Description = "", Default = true})
...
iceWalk = Tabs.Misc:AddToggle("iceWalk", {Title = "Turn on Ice Walk", Description = "Creates ice effect when walking on water", Default = false})
