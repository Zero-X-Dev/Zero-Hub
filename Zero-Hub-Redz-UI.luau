...
["Color Hub 1"] = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(27, 31, 72)),   -- dark blue-purple
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(52, 69, 130)),-- light blue-purple (highlight)
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(52, 69, 130))    -- dark blue-purple
}),
["Color Hub 2"] = Color3.fromRGB(27, 31, 72),      -- light blue-purple background
["Color Stroke"] = Color3.fromRGB(27, 31, 72), -- bright blue border
["Color Theme"] = Color3.fromRGB(125, 64, 145),  -- pastel blue-purple
["Color Text"] = Color3.fromRGB(228, 243, 250),    -- prominent blue text
["Color Dark Text"] = Color3.fromRGB(228, 243, 250) -- secondary blue-purple text
        }
    },
	Info = {
		Version = "1.1.0"
...
bg.Image = "rbxassetid://79773252738743" -- change to your image ID
...
local DropdownHolder = Create("Folder", ScreenGui, {
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Tuấn Anh IOS",
			Text = "Do you want to turn off the script?",
			Options = {
				{"Turn Off", function()
					ScreenGui:Destroy()
				end},
